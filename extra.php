            ...
            <div class="col-6">
                <div class="col">
                    <div class="education-experience-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-1">
                        <h4 class="edu-sub-title">B.E Artificial Intelligence & Machine Learning</h4>
                        <h3 class="edu-title">Universal College of Engineering</h3>
                        <h2 class="edu-title">10/2018 - 05/2021</h2>
                    </div>
                </div>
                <div class="col mt-5">
                    <div class="education-experience-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-2">
                        <h4 class="edu-sub-title">Diploma in Information Technology</h4>
                        <h3 class="edu-title">Universal College of Engineering</h3>
                        <h2 class="edu-title">10/2018 - 05/2021</h2>
                    </div>
                </div>
                <div class="col mt-5">
                    <div class="education-experience-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-3">
                        <h4 class="edu-sub-title">Maharashtra State Board of Secondary and Higher Secondary Education</h4>
                        <h3 class="edu-title">Universal College of Engineering</h3>
                        <h2 class="edu-title">06/2017 - 04/2018</h2>
                    </div>
                </div>
            </div>
