            ...
            <div class="row">
                <div>
                    <div class="main-wrapper">
                        <p class="copy-right-para tmp-link-animation"> ©<a href="https://themeforest.net/user/inversweb/portfolio" target="_blank"> </a>
                            <script>
                                document.write(new Date().getFullYear())
                            </script> | All Rights Reserved
                        </p>
                        <p class="copy-right-para tmp-link-animation"> Created with <img title='Heart' style="width: 18px;" src="assets\images\language\heart.svg" alt="heart" /> by Roshan Yadav
                        </p>
                    </div>
                </div>
            </div>
    ...
    <a href="https://wa.me/8928339535" target="_blank"><div class="ready-chatting-option tmp-ready-chat">
        <label for="click">
